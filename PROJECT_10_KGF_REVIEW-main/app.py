...
st.image("ChatGPT Image Jul 11, 2026, 02_53_11 PM.png", use_column_width=True)
# ---------------------------------
...
with col1:
    ...
    st.write("## Divyanshu Mani Tripathi")
    st.write("B.Tech IT ")
    st.write("Machine Learning & Data Science Enthusiast")

with col2:
    st.markdown("### 🔗 Connect with Me")
    st.markdown("[💼 LinkedIn](www.linkedin.com/in/divyanshu-mani-tripathi-7b57b2297)")
    st.markdown("[💻 GitHub](https://lnkd.in/gQBDkss2)")
